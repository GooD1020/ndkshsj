...
local win = library:AddWindow("5X"," HUB V0.3","Kaitan","6023426909","",Enum.KeyCode.RightControl)
...
item:AddButton("5X hub ",function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/Cve-Hub/LUNARHUBnewUI/main/Protected20%(14).lua'))()
end)
